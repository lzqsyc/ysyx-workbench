...
extern const VlUnpacked<CData/*7:0*/, 16> Vdecode3_8__ConstPool__TABLE_h32091409_0;
...
VL_INLINE_OPT void Vdecode3_8___024root___ico_sequent__TOP__0(Vdecode3_8___024root* vlSelf) {
    ...
    vlSelfRef.y = Vdecode3_8__ConstPool__TABLE_h32091409_0
        [__Vtableidx1];
}
...
#endif
            VL_FATAL_MT("prj_8/vsrc/decode3_8.v", 1, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("prj_8/vsrc/decode3_8.v", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("prj_8/vsrc/decode3_8.v", 1, "", "Active region did not converge.");
            }
