...
void nvboard_bind_all_pins(Vtop* top) {
	nvboard_bind_pin( &top->sel, 1, BTNC);
	nvboard_bind_pin( &top->cin, 1, BTNL);
	nvboard_bind_pin( &top->sw_b, 8, SW7, SW6, SW5, SW4, SW3, SW2, SW1, SW0);
	nvboard_bind_pin( &top->sw_a, 8, SW15, SW14, SW13, SW12, SW11, SW10, SW9, SW8);
