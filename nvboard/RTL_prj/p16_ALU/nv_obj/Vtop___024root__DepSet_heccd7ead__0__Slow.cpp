...
#endif
            VL_FATAL_MT("p16_ALU/vsrc/top.v", 2, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__sum = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 10396652434074685485ull);
    vlSelf->top__DOT__my_alu__DOT__able_b = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 15784292526741729187ull);
    vlSelf->top__DOT__my_alu__DOT__sub_sum = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 8382817206661880043ull);
    vlSelf->top__DOT__my_alu__DOT__add_sum = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 16986063070875351335ull);
