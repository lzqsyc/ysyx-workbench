...
module seg_show (
    ...
    wire [7:0] seg4_int = encode_bit(cout, overflow);
    wire [7:0] seg5_int = encode_bit(1'b0, 1'b0);
    wire [7:0] seg6_int = encode_bit(1'b0, 1'b0);
    wire [7:0] seg7_int = encode_bit(1'b0, 1'b0);
