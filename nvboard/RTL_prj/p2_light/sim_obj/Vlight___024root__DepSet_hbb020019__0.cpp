...
VL_INLINE_OPT void Vlight___024root___nba_sequent__TOP__0(Vlight___024root* vlSelf) {
    ...
    if (vlSelfRef.rst) {
        __Vdly__led = 1U;
        vlSelfRef.light__DOT__count = 0U;
    } else if ((0U == vlSelfRef.light__DOT__count)) {
...
#endif
            VL_FATAL_MT("prj_3/vsrc/light.v", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("prj_3/vsrc/light.v", 1, "", "Active region did not converge.");
            }
