...
void Vencode4_2___024root__trace_chg_0_sub_0(Vencode4_2___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vencode4_2___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vencode4_2___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vencode4_2___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vencode4_2___024root__trace_chg_0_sub_0(Vencode4_2___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vencode4_2___024root__trace_chg_0_sub_0\n"); );
    Vencode4_2__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
void Vencode4_2___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vencode4_2___024root__trace_cleanup\n"); );
    // Init
    Vencode4_2___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vencode4_2___024root*>(voidSelf);
    Vencode4_2__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
