...
#endif
            VL_FATAL_MT("p16_ram/vsrc/top.v", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->w_addr = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 15030644522466382671ull);
    vlSelf->r_addr = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 13214715527556913500ull);
    ...
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->top__DOT__my_ram__DOT__ram[__Vi0] = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 4566863309933909772ull);
    }
