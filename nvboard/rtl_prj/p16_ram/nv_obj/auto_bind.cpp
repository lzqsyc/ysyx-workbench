...
void nvboard_bind_all_pins(Vtop* top) {
	nvboard_bind_pin( &top->we, 1, BTNC);
	nvboard_bind_pin( &top->w_addr, 4, SW3, SW2, SW1, SW0);
	nvboard_bind_pin( &top->w_data, 8, SW15, SW14, SW13, SW12, SW11, SW10, SW9, SW8);
	nvboard_bind_pin( &top->r_addr, 4, SW7, SW6, SW5, SW4);
	nvboard_bind_pin( &top->r_data, 8, LD7, LD6, LD5, LD4, LD3, LD2, LD1, LD0);
