...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    __Vdly__dout = 0;
    IData/*31:0*/ __Vdly__top__DOT__u_lfsr__DOT__cycle_count;
    __Vdly__top__DOT__u_lfsr__DOT__cycle_count = 0;
    // Body
    __Vdly__top__DOT__u_lfsr__DOT__cycle_count = vlSelfRef.top__DOT__u_lfsr__DOT__cycle_count;
    __Vdly__dout = vlSelfRef.dout;
    if (vlSelfRef.rst) {
        __Vdly__dout = 1U;
        __Vdly__top__DOT__u_lfsr__DOT__cycle_count = 0U;
    } else if ((0U == vlSelfRef.top__DOT__u_lfsr__DOT__cycle_count)) {
        __Vdly__dout = (((IData)(vlSelfRef.top__DOT__u_lfsr__DOT__feedback) 
                         << 7U) | (0x7fU & ((IData)(vlSelfRef.dout) 
                                            >> 1U)));
    } else {
        __Vdly__top__DOT__u_lfsr__DOT__cycle_count 
            = ((0x1dcd6500U <= vlSelfRef.top__DOT__u_lfsr__DOT__cycle_count)
                ? 0U : ((IData)(1U) + vlSelfRef.top__DOT__u_lfsr__DOT__cycle_count));
    }
    vlSelfRef.top__DOT__u_lfsr__DOT__cycle_count = __Vdly__top__DOT__u_lfsr__DOT__cycle_count;
