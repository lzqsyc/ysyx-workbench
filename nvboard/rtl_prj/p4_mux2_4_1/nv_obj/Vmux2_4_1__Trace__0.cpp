...
void Vmux2_4_1___024root__trace_chg_0_sub_0(Vmux2_4_1___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vmux2_4_1___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmux2_4_1___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vmux2_4_1___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vmux2_4_1___024root__trace_chg_0_sub_0(Vmux2_4_1___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmux2_4_1___024root__trace_chg_0_sub_0\n"); );
    Vmux2_4_1__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    ...
    bufp->chgCData(oldp+4,(vlSelfRef.s),2);
    bufp->chgCData(oldp+5,(vlSelfRef.y),2);
}

void Vmux2_4_1___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmux2_4_1___024root__trace_cleanup\n"); );
    // Init
    Vmux2_4_1___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vmux2_4_1___024root*>(voidSelf);
    Vmux2_4_1__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
