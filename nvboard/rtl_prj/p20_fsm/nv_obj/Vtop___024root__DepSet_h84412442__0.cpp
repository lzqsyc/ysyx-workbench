...
void Vtop___024root___eval_triggers__act(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.__VactTriggered.setBit(2U, ((~ (IData)(vlSelfRef.top__DOT____Vcellinp__u_com_fsm__rst_n)) 
                                          & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__DOT____Vcellinp__u_com_fsm__rst_n__0)));
